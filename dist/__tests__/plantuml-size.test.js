...
describe("autoImageSize", () => {
    test("масштабирует до maxWidth по умолчанию (624)", () => {
        ...
        const { width, height } = (0, plantuml_size_1.autoImageSize)(buf);
